...
CREATE TABLE `sanpham` (
  ...
  `NgayTiepNhan` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111002','2018/02/05','10390000','0','1');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111003','2018/03/07','115000000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111002','2016/01/06','15200000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111003','2017/01/24','40000000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111001','2014/11/21','9000000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111001','2015/12/04','12000000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111002','2016/04/07','105000000','1','0');

INSERT INTO donhang (KhachHang,ThoiGian,TongTien,TrangThai, DangGiao) VALUES 
('11111001','2017/12/15','5000000','1','0');
...
III KIT EF 24-105 F4L IS USM/2-3.jpg','57500000','5240','920','523','Khả năng chụp
 ...
 một điểm đáng chú ý của sản phẩm này.','3','33333001','2017/07/12');
...
'2368','450','204','So với thế hệ trước, máy ảnh Fujifilm FinePix XP120 hoàn toàn vượt trội về độ bền
 ...
 bẩn và nằng gió thì máy cũng hoạt động một cách hoàn hảo nhất.','4','33333003','2015/10/02');
...
lanh cùng giọng nói chân thực là những gì mà  C615 mang đến cho bạn. Ngoài ra, thiết bị có thể  đính
 kèm chân máy Tripod giúp bạn quay nhiều góc độ khác nhau.','6','33333005','2017/08/21');
...
'Tại PC+ 2016, Nikon đã tung ra ba sản phẩm mới mà máy ảnh Nikon Coopix B700 là một trong số đó. Thông
 ...
 ra rất thuận lợi cho việc cầm nắm khi chụp ảnh. Bề mặt trơn nhẵn không sần sùi.','6','33333006','2017/05/22');
...
nghiệm mới mẻ.','6','33333008','2013/06/23');
